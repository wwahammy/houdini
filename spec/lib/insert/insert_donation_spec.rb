  ...
  describe '.offsite' do
    ...
    describe 'success' do 
      ...
      it 'general offsite create' do
        expect(Houdini.event_publisher).to receive(:announce).with(:supporter_created, any_args)
        expect(Houdini.event_publisher).to receive(:announce).with(:supporter_address_created, any_args)
        expect(Houdini.event_publisher).to receive(:announce).with(:transaction_created, any_args)
        expect(Houdini.event_publisher).to receive(:announce).with(:transaction_created, any_args)
