...
import Sepa from './payment_methods/stripe/StripeSepa';
...
export function sepaOnlyPane() {
	return <PaymentMethodPane paymentMethods={[
		{name: 'sepa', title: 'SEPA', component: Sepa }
	]} amount={Money.fromCents(1000, 'usd')} setPaymentMethodProps={action('set-payment-method-data')}
	paymentMethodData={{}}/>;
}
...
export function stripeBothCardPane() {
	return <PaymentMethodPane paymentMethods={[
		{name: 'stripeCard', title: 'Credit Card', component: StripeCard },
		{name: 'stripeSEPA', title: 'SEPA', component: Sepa },
	]} amount={Money.fromCents(1000, 'usd')} setPaymentMethodProps={action('set-payment-method-data')}
	paymentMethodData={{}}/>;
}
